...
public class CruddemoApplication {
	...
	private void deleteStudent(AppDAO appDAO) {
		...
		System.out.println("FINITO PEPITO");
	}
	...
	private void findStudentAndCourses(AppDAO appDAO) {
		...
		System.out.println("The student is:" + tempStudent);
		System.out.println("There courses are:" + tempStudent.getCourses());
	...
	private void findCourseAndStudents(AppDAO appDAO) {
		...
		System.out.println("The students in this course are:" + tempCourse.getStudents());
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		//create course
		Course tempCourse = new Course("Gardening 101");

		// create students
		Student tempStudent1 = new Student("Troye", "Sivan", "troye@gmail.com");
		Student tempStudent2 = new Student("Ariane", "Grande", "ariana@gmail.com");
		...
		System.out.println("The student in the course are: " + tempCourse.getStudents());
